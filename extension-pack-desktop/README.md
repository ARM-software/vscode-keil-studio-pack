...
The main Keil Studio extensions available with this pack are **Arm CMSIS csolution**, **Arm Device Manager** and **Arm Embedded Debugger**. The extensions can be used together by installing this pack, enabling you to manage CMSIS solutions (csolution projects), run projects on a device and undertake debugging. Each extension can also be used individually.
